...
#ruledef mnemonics
{
    ...
    jmp.of {end: addr}                    => 0b000010 @ 0b1011 @ 0b000000 @ end
    jmp.nof {end: addr}                   => 0b000010 @ 0b1100 @ 0b000000 @ end
    ...
    call.of {end: addr}                   => 0b000011 @ 0b1011 @ 0b000000 @ end
    call.nof {end: addr}                  => 0b000011 @ 0b1100 @ 0b000000 @ end
